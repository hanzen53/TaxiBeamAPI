...
map.on('dragend', function(e){
	var hiddenloc = map.getCenter();
	//console.log('latlon = '+hiddenloc.lat+', '+hiddenloc.lng);
	//console.log('hiddenloc = '+hiddenloc)		
...
function addPoiJsonFirst(JsonData) {	
	...
	map.setView([ JsonData.coordinates[1],JsonData.coordinates[0] ], 18);
	map.addLayer(putPsg);
}
