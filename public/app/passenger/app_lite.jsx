...
map.on('dragend', function(e){
	...
	console.log(' share locatoin 1 ')
	if(navigator.geolocation) {
		console.log(' share locatoin 2 ')
		navigator.geolocation.getCurrentPosition(function(position) {		      	
			console.log(' share locatoin 3 ')
...
function gatMeaTaxi () {
	...
	if(navigator.geolocation) {
		navigator.geolocation.getCurrentPosition(function(position) {		      	
			...
			console.log(' PsgLat1 = '+ PsgLat )
			console.log(' PsgLat2 = '+ PsgLat )
			/*
			$.ajax({ 
				type: "POST", 
				contentType: "application/json; charset=utf-8", 
	...
	if ( $('#psgto').val()=='' || $('#psgphone').val().length <= 8 ){				
		...
		// } else {
			...
			console.log(' PsgLat3 = '+ PsgLat )
			console.log(' temp_curaddr_add = '+temp_curaddr_add)
			var data = {
				device_id: tempid ,
